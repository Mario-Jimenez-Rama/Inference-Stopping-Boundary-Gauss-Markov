...
inferred_files <- list.files(folder_name, pattern = "inferred_boundary_rational_.*\\.rds", full.names = TRUE)
...
real_boundary <- readRDS(file.path(folder_name, "boundary_rational.rds"))
